...
type ComplexityRoot struct {
	MyMutation struct {
		CreateTodo func(childComplexity int, todo TodoInput, state State) int
	}
...
type MyMutationResolver interface {
	CreateTodo(ctx context.Context, todo TodoInput, state State) (ToDo, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "MyMutation.createTodo":
		...
		return e.complexity.MyMutation.CreateTodo(childComplexity, args["todo"].(TodoInput), args["state"].(State)), true
...
func (ec *executionContext) _MyMutation_createTodo(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.MyMutation().CreateTodo(rctx, args["todo"].(TodoInput), args["state"].(State))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
